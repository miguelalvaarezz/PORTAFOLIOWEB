  ...
  const activeTournaments = [
    {
      ...
      location: "Club de Pádel Elite, Pistas 1-6",
    ...
    },
    {
      ...
      location: "Club de Pádel Elite, Pistas 3-5",
  ...
  const upcomingTournaments = [
    {
      ...
      location: "Club de Pádel Elite, Todas las pistas",
    ...
    },
    {
      ...
      location: "Club de Pádel Elite, Pistas 1-4",
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="absolute top-8 left-8 z-50">
        <Link href="/#proyectos" className="flex items-center space-x-3 group">
          <div className="w-10 h-10 flex items-center justify-center border-2 border-red-500 rounded group-hover:border-red-400 transition-colors duration-300">
            <span className="text-xl font-bold text-[#EF4444] group-hover:text-[#EF4444]/80 transition-colors duration-300">
              M
            </span>
          </div>
          <div className="flex items-baseline space-x-2">
            <span className="text-xl font-semibold text-gray-900 group-hover:text-[#EF4444] transition-colors duration-300">
              Miguel
            </span>
      ...
      {/* Hero Header */}
      <div className="relative px-6 pt-24 pb-12 max-w-7xl mx-auto">
        <motion.div
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black text-gray-900 mb-4">
            ...
            <span className="block text-[#EF4444]">Torneos</span>
          </h1>
          
          <div className="inline-flex items-center gap-3 bg-[#EF4444]/10 px-6 py-3 rounded-2xl mb-8">
            <Trophy className="w-5 h-5 text-[#EF4444]" />
            <p className="text-lg font-medium text-gray-900">
              Organiza y gestiona torneos de forma profesional
            </p>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl shadow-2xl p-12 mb-12 max-w-7xl mx-auto"
        >
          {/* Tabs */}
          ...
          {[
            ...
            <button
              ...
              className={`relative px-6 py-3 rounded-2xl font-semibold transition-all duration-300 ${
                selectedTab === tab.id
                  ? "bg-[#EF4444] text-gray-900 shadow-lg"
          ...
          {selectedTab === "activos" && activeTournaments.map((tournament, index) => (
            ...
            >
              <div className={`bg-gradient-to-br from-${tournament.color}-500 to-${tournament.color}-600 p-8 relative min-h-[250px]`}>
                {/* Content */}
              ...
              <div className="p-6 bg-gray-50">
                ...
                <div className="w-full bg-gray-200 rounded-full h-3 mb-4">
                  <div
                    className={`bg-gradient-to-r from-${tournament.color}-500 to-${tournament.color}-600 h-3 rounded-full transition-all duration-500`}
                    style={{ width: '100%' }}
                  />
                </div>
      ...
      <AnimatePresence>
        {selectedTournament && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className={`bg-gradient-to-br from-${selectedTournament.color || 'blue'}-500 to-${selectedTournament.color || 'blue'}-600 p-8 relative`}>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-3 rounded-t-xl font-semibold transition-all duration-300 ${
                        infoModalTab === tab.id
                          ? "bg-white text-[#EF4444] border-t border-l border-r border-gray-200"
              ...
              <div className="p-8 max-h-[60vh] overflow-y-auto">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 p-6 rounded-2xl">
                    <Target className="w-8 h-8 text-[#EF4444] mb-3" />
                ...
                {/* Schedule */}
                <div className="bg-gray-50 p-6 rounded-2xl">
                  <Clock className="w-8 h-8 text-[#EF4444] mb-3" />
                ...
                {selectedTournament.classification && (
                  <div className="bg-gradient-to-r from-[#EF4444]/10 to-transparent p-6 rounded-2xl border-2 border-[#EF4444]/20">
                    <Star className="w-8 h-8 text-[#EF4444] mb-3" />
                ...
                {infoModalTab === "matches" && (
                  <div className="space-y-6">
                    {/* Upcoming Matches */}
                    {selectedTournament.upcomingMatches && (
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    ...
                    {/* Past Matches */}
                    {selectedTournament.pastMatches && (
                      <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                          <Award className="w-6 h-6 text-[#EF4444]" />
                          Partidos Anteriores
                              ...
                              <div className="grid md:grid-cols-3 gap-4 items-center">
                                ...
                                <div className="text-center">
                                  <div className="flex items-center justify-center gap-2">
                                    <span className="text-2xl font-black text-[#EF4444]">{match.score1}</span>
      ...
      <AnimatePresence>
        {selectedClassification && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className={`bg-gradient-to-br from-${selectedClassification.color || 'blue'}-500 to-${selectedClassification.color || 'blue'}-600 p-8 relative`}>
                <button
                  onClick={() => setSelectedClassification(null)}
                  className="absolute top-4 right-4 text-white hover:text-gray-200 transition-colors"
                >
      ...
      <AnimatePresence>
        {showRegistrationModal && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className={`bg-gradient-to-br from-${showRegistrationModal.color || 'blue'}-500 to-${showRegistrationModal.color || 'blue'}-600 p-8 relative`}>
                <button
                  onClick={() => setShowRegistrationModal(null)}
                  className="absolute top-4 right-4 text-white hover:text-gray-200 transition-colors"
                >
              ...
              <div className="p-8">
                <form className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-2xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input type="text" required className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#EF4444] focus:outline-none transition-colors" />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input type="tel" required className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#EF4444] focus:outline-none transition-colors" />
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-900 mb-2">Email *</label>
                        <input type="email" required className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#EF4444] focus:outline-none transition-colors" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea rows={4} className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-[#EF4444] focus:outline-none transition-colors" placeholder="Alergias, preferencias de horario, etc." />
                  </div>
                  ...
                  {/* Submit */}
                  <button type="submit" className="w-full bg-[#EF4444] text-white py-4 rounded-xl font-semibold hover:bg-[#EF4444]/90 transition-colors duration-300 flex items-center justify-center gap-2">
